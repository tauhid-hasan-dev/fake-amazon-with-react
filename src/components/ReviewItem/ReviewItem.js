...
const ReviewItem = ({product, handleRemoveItem}) => {
    const {name, quantity, price, shipping,  img, id} = product;
    return (
        <div className='flex  border-2 gap-5 rounded-lg p-2'>
            ...
            <div className='flex   items-center justify-between w-full'>
                ...
                <div className='text-2xl lg:text-5xl  text-red-500  hover:text-red-700 cursor-pointer  p-2 lg:p-5 ' onClick={()=> handleRemoveItem(id)}>
